...
from dqn.infrastructure.rl_trainer import RL_Trainer
from dqn.agents.dqn_agent import DQNAgent
from dqn.infrastructure.dqn_utils import get_env_kwargs
...
def main():
    ...
    parser.add_argument(
        '--env_name',
        default='MsPacman-v0',
        choices=('MountainCar-v0', 'LunarLander-v3', 'BreakoutNoFrameskip-v4',
                 'MsPacman-v0', 'PongNoFrameskip-v4', 'FreewayNoFrameskip-v4')
    )
    ...
    logdir = 'dqn_' + args.exp_name + '_' + args.env_name + '_' + time.strftime("%d-%m-%Y_%H-%M-%S")
